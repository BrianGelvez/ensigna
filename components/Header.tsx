            ...
            >
              ...
              <div className="px-4 pt-4 border-t border-gray-200 space-y-2">
                <Link
                  href={`/public/${process.env.NEXT_PUBLIC_CLINIC_SLUG || 'consultorio-ensigna'}/agenda`}
                  onClick={() => setIsMobileMenuOpen(false)}
                  className="block w-full text-center px-4 py-3 bg-red-600 text-white rounded-lg font-medium hover:bg-red-700 transition-colors"
                >
                  Solicitar turno
                </Link>
                <Link
                  href="/login"
                  onClick={() => setIsMobileMenuOpen(false)}
                  className="block w-full text-center px-4 py-2 text-sm text-gray-500 hover:text-gray-700 transition-colors"
                  title="Acceso para profesionales"
                >
                  Ingresar
                </Link>
